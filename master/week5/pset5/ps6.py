...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter in range(len(string.ascii_lowercase)):
            shift_dict[string.ascii_lowercase[letter]] = string.ascii_lowercase[(letter + shift) % 26]
        for letter in range(len(string.ascii_uppercase)):
            shift_dict[string.ascii_uppercase[letter]] = string.ascii_uppercase[(letter + shift) % 26]
        return shift_dict
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        most_words = 0
        for i in range(26):
            current_string = self.apply_shift(i)
